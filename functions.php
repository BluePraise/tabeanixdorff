...
function tn_styles_scripts() {
    ...
    wp_register_script( 'tn_flickity', get_template_directory_uri() . '/assets/js/vendor/flickity.min.js', array('jquery'), '2.3.0', true);
    wp_register_script( 'tn_flickity-custom', get_template_directory_uri() . '/assets/js/slider.js', array('jquery'), '0.01', true);
	wp_register_script( 'tn_script', get_template_directory_uri() . '/assets/js/script.js', array(), '2.0.0', true);

    wp_enqueue_style('tn_style');

    // if is single page
    if (is_single()) :
        wp_enqueue_script('tn_flickity');
        wp_enqueue_script('tn_flickity-custom');
    endif;
